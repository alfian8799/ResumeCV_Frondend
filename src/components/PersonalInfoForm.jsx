  ...
  return (
    <div className="flex flex-col gap-5 w-full">
      <div className="border-b border-neutral-800 pb-2 mb-2">
        ...
        <p className="text-xs text-neutral-500 mt-1">Masukkan informasi dasar dan kontak Anda di sini.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-2">
        ...
        {/* Job Title */}
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-medium text-neutral-400">Posisi / Pekerjaan</label>
          <input
            type="text"
            value={data?.jobTitle === "Default Email" ? "" : data?.jobTitle || ""}
        ...
        {/* Phone */}
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-medium text-neutral-400">Nomor Telepon</label>
          <input
            type="telephone"
        ...
        {/* LinkedIn */}
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-medium text-neutral-400">URL LinkedIn</label>
          <input
            type="url"
        ...
        {/* Portfolio */}
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-medium text-neutral-400">URL Portfolio / Website</label>
          <input
            type="url"
