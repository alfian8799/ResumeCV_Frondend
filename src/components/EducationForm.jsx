  ...
  return (
    <div className="flex flex-col gap-5 w-full">
      <div className="border-b border-neutral-800 pb-2 mb-2">
        ...
        <p className="text-xs text-neutral-500 mt-1">Tambahkan riwayat pendidikan formal Anda.</p>
      </div>
      ...
      <div className="flex flex-col gap-6">
        {data.map((edu, index) => (
          <div key={index} className="bg-neutral-950 border border-neutral-800 p-5 rounded-xl relative group">
            ...
            <h4 className="text-sm font-semibold text-violet-400 mb-4">Pendidikan #{index + 1}</h4>

            {/* Form Input Grid */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              
              <div className="flex flex-col gap-1.5 md:col-span-2">
                <label className="text-xs font-medium text-neutral-400">Nama Institusi / Universitas</label>
                <input
                  type="text"
                  value={edu.institutionName || ""}
                  onChange={(e) => handleChangeItem(index, "institutionName", e.target.value)}
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-medium text-neutral-400">Gelar</label>
                <input
                  type="text"
                  value={edu.degree || ""}
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-medium text-neutral-400">Bidang Studi / Jurusan</label>
                <input
                  type="text"
                  value={edu.fieldOfStudy || ""}
                  onChange={(e) => handleChangeItem(index, "fieldOfStudy", e.target.value)}
             ...
             <div className="flex flex-col gap-1.5">
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-medium text-neutral-400">Bulan & Tahun Lulus (Atau "Sekarang")</label>
                <input
                  type="text"
                  value={edu.endDate || ""}
              ...
              <div className="flex flex-col gap-1.5 md:col-span-2">
                <label className="text-xs font-medium text-neutral-400">IPK / Nilai (Opsional)</label>
                <input
                  type="text"
                  value={edu.gpa || ""}
                  onChange={(e) => handleChangeItem(index, "gpa", e.target.value)}
              ...
              <div className="flex flex-col gap-1.5 md:col-span-2">
                <label className="text-xs font-medium text-neutral-400">Deskripsi Singkat (Opsional)</label>
                <textarea
